...
public class UserDao {
    ...
    public void updateHavingClass(String uid,int classId){
        try{
            String sql="update userinfo set havingClass=? where uid=?";
            qr.update(sql,classId, uid);
        }catch (SQLException e){
            throw new RuntimeException(e);
        }
    }
    ...
    public void add(User user) {
        try {
            ...
            Object[] params = {user.getUid(),user.getUsername(), user.getPassword(),
                    ...
                    user.getPhone(), user.getUclassNumber(), user.getTrueName(), user.getSchoolId(),user.getHavingClass()};
